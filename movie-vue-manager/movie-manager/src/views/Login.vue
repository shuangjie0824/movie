        ...
        <div class="login-form">
            <div class="login-form-header">
                <img style="width: 75px; height: 75px;float: left;padding-right: 30px;" src="../assets/img/logo.png"
                    alt="" />
                <div class="login-form-text">电影售票系统 - 后台管理</div>
            </div>
                ...
                <div style="padding-top: 10px">
                    ...
                    <div style="float: right">
                        <el-tooltip class="item" effect="dark" content="请联系管理员修改" placement="bottom">
                            <el-link style="font-weight: bolder;font-size: 14px;color: #000000;" :underline="false">
                                忘记密码?
                            </el-link>
                        </el-tooltip>
                    </div>
            ...
            <div class="login-form-footer">
                <div style="font-weight: bolder;font-size: 16px;color: #000000;" :underline="false">
                    电影售票系统 - 后台管理
                </div>
            </div>
        </div>
