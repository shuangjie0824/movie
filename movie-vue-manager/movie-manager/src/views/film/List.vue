<template>
  <div class="film-list">
    ...
    <el-dialog title="电影信息修改" :visible.sync="dialog1" width="60%">
      ...
      <el-form ref="form" style="padding: 20px" :model="form" label-width="80px">
        ...
        <el-form-item label="上映时间">
          <el-col :span="11">
            <el-date-picker type="date" value-format="yyyy年-MM月-dd日" placeholder="选择日期" v-model="form.releaseTime"
    ...
    <el-table v-loading="tableLoading"
      ...
      <el-table-column label="上映时间" prop="releaseTime">
      </el-table-column>
      ...
      <el-table-column width="280" align="right">
        ...
        <template style="white-space: nowrap" slot-scope="scope">
          ...
          <el-button size="mini" icon="el-icon-circle-plus" type="success" @click="handleArrange(scope.$index,scope.row)">排片</el-button>
